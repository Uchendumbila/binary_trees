...
/**
 * binary_tree_levelorder - Writing a fxn that traverst a binary tree
...
/**
 * btlo_helper - Writing a fxn that goes through a binary tree
...
/**
 * binary_tree_height - Writing a fxn that measures the height
 * of a binary tree
