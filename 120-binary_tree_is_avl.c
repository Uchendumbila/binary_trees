...
/**
 * binary_tree_is_avl - Writing a fxn that finds if a binary tree is an avl
...
/**
 * btia_helper - Writing a fxn that helper that finds
 * if a binary tree is an avl
 * @tree: pointer to the root node of the tree
 * @min: minimum value
 * @max: maximum value
 *
...
/**
 * binary_tree_height - Writing a fxn that measures
